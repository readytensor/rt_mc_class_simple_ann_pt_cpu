# Artificial Neural Network Multiclass Classifier in PyTorch (CPU) with Shapley Explanations
## Project Description
...
- A **Artificial Neural Network (ANN)** Multiclass Classifier built using **PyTorch**. The model runs on CPU.
